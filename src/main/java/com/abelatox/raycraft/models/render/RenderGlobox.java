...
public class RenderGlobox extends EntityRenderer<LivingEntity> implements IRayCraftRender {
	float scale;
	private ModelGlobox model;

	public RenderGlobox(EntityRendererManager renderManager, ModelGlobox model, float scale) {
		super(renderManager);
		this.model = model;
		this.scale = scale;
	}
